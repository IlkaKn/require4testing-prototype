...
Datenbank-Import (Optional):Damit das Programm direkt mit Testdaten startet, kann die beigefügte Datei require4testing-db.sql in die leere MySQL-Datenbank importiert werden.So sind bereits erste Anforderungen, Testfälle und Testläufe vorhanden, um die Funktionen sofort zu testen.<br>
